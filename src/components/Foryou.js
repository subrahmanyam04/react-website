...
const Foryou = ({
    ...
    //     console.log("zink",aboutcard[0].id)
    ...
    const handleCardClick = (aboutcard) => {
        console.log("icnscnnc aboutcard", aboutcard);
        // console.log("aboutcard id",aboutcard[].title )
    ...
    // const mappingdata = (status) => {
    //     var actualdata = data.map((item)=>{
    //         alert("hi")
    //         console.log('i am actualdata',actualdata)
    //         if(item.status === status)
    //         return(
    //          <div>
    //             <p>{actualdata.pname}</p>
    //          </div>
    //     )
    //     })
    // }
                    ...
                    <div className='col-md-12 col-xxl-9 col-xl-9 col-lg-9'>
                        {data &&
                            data.map((user, index) => {
                                 ...
                                 if(user.status=='foryou'){
                                //  console.log('hiscnsicnc',user.aboutcard.index)
                                return (

                                    <div class="card border border-0" key={index} onClick={() => handleCardClick(user.aboutcard)}>
